...
/** not-@type {!BigUint64Array} */ HEAPU64;
    ...
    var _y_engine_new = (Module["_y_engine_new"] =
      makeInvalidEarlyAccess("_y_engine_new"));

    var _y_engine_try_parse_to_builder = (Module[
      "_y_engine_try_parse_to_builder"
    ] = makeInvalidEarlyAccess("_y_engine_try_parse_to_builder"));

    var _y_engine_get_new_last_error = (Module["_y_engine_get_new_last_error"] =
      makeInvalidEarlyAccess("_y_engine_get_new_last_error"));

    var _y_engine_dsp_set = (Module["_y_engine_dsp_set"] =
      makeInvalidEarlyAccess("_y_engine_dsp_set"));

    var _y_engine_dsp_node_prepare = (Module["_y_engine_dsp_node_prepare"] =
      makeInvalidEarlyAccess("_y_engine_dsp_node_prepare"));

    var _y_engine_dsp_node_process = (Module["_y_engine_dsp_node_process"] =
      makeInvalidEarlyAccess("_y_engine_dsp_node_process"));

    var _y_optional_dsp_build_fn_has_value = (Module[
      "_y_optional_dsp_build_fn_has_value"
    ] = makeInvalidEarlyAccess("_y_optional_dsp_build_fn_has_value"));

    var _y_engine_set_slider = (Module["_y_engine_set_slider"] =
      makeInvalidEarlyAccess("_y_engine_set_slider"));

    var _y_optional_dsp_build_fn_free = (Module[
      "_y_optional_dsp_build_fn_free"
    ] = makeInvalidEarlyAccess("_y_optional_dsp_build_fn_free"));

    var _y_engine_free = (Module["_y_engine_free"] =
      makeInvalidEarlyAccess("_y_engine_free"));

    var _y_engine_set_toggle = (Module["_y_engine_set_toggle"] =
      makeInvalidEarlyAccess("_y_engine_set_toggle"));

    var _y_engine_set_button = (Module["_y_engine_set_button"] =
      makeInvalidEarlyAccess("_y_engine_set_button"));

    var _y_engine_set_meter_callback = (Module["_y_engine_set_meter_callback"] =
      makeInvalidEarlyAccess("_y_engine_set_meter_callback"));

    var _y_engine_set_led_callback = (Module["_y_engine_set_led_callback"] =
      makeInvalidEarlyAccess("_y_engine_set_led_callback"));

    var _y_engine_set_action_led_callback = (Module[
      "_y_engine_set_action_led_callback"
    ] = makeInvalidEarlyAccess("_y_engine_set_action_led_callback"));

    var _malloc = (Module["_malloc"] = makeInvalidEarlyAccess("_malloc"));

    var _y_engine_get_amplitude_response_svg = (Module[
      "_y_engine_get_amplitude_response_svg"
    ] = makeInvalidEarlyAccess("_y_engine_get_amplitude_response_svg"));

    var _y_engine_get_phase_response_svg = (Module[
      "_y_engine_get_phase_response_svg"
    ] = makeInvalidEarlyAccess("_y_engine_get_phase_response_svg"));

    var _y_engine_get_transfer_function_svg = (Module[
      "_y_engine_get_transfer_function_svg"
    ] = makeInvalidEarlyAccess("_y_engine_get_transfer_function_svg"));

    var _y_macro_simple_graph = (Module["_y_macro_simple_graph"] =
      makeInvalidEarlyAccess("_y_macro_simple_graph"));

    var _free = (Module["_free"] = makeInvalidEarlyAccess("_free"));

    var __initialize = (Module["__initialize"] =
      makeInvalidEarlyAccess("__initialize"));
    ...
    function assignWasmExports(wasmExports) {
      Module["_y_engine_new"] = _y_engine_new = createExportWrapper(
        "y_engine_new",
        0,
      );
      Module["_y_engine_try_parse_to_builder"] =
        _y_engine_try_parse_to_builder = createExportWrapper(
          "y_engine_try_parse_to_builder",
          2,
        );
      Module["_y_engine_get_new_last_error"] = _y_engine_get_new_last_error =
        createExportWrapper("y_engine_get_new_last_error", 1);
      Module["_y_engine_dsp_set"] = _y_engine_dsp_set = createExportWrapper(
        "y_engine_dsp_set",
        2,
      );
      Module["_y_engine_dsp_node_prepare"] = _y_engine_dsp_node_prepare =
        createExportWrapper("y_engine_dsp_node_prepare", 4);
      Module["_y_engine_dsp_node_process"] = _y_engine_dsp_node_process =
        createExportWrapper("y_engine_dsp_node_process", 3);
      Module["_y_optional_dsp_build_fn_has_value"] =
        _y_optional_dsp_build_fn_has_value = createExportWrapper(
          "y_optional_dsp_build_fn_has_value",
          1,
        );
      Module["_y_engine_set_slider"] = _y_engine_set_slider =
        createExportWrapper("y_engine_set_slider", 3);
      Module["_y_optional_dsp_build_fn_free"] = _y_optional_dsp_build_fn_free =
        createExportWrapper("y_optional_dsp_build_fn_free", 1);
      Module["_y_engine_free"] = _y_engine_free = createExportWrapper(
        "y_engine_free",
        1,
      );
      Module["_y_engine_set_toggle"] = _y_engine_set_toggle =
        createExportWrapper("y_engine_set_toggle", 3);
      Module["_y_engine_set_button"] = _y_engine_set_button =
        createExportWrapper("y_engine_set_button", 2);
      Module["_y_engine_set_meter_callback"] = _y_engine_set_meter_callback =
        createExportWrapper("y_engine_set_meter_callback", 3);
      Module["_y_engine_set_led_callback"] = _y_engine_set_led_callback =
        createExportWrapper("y_engine_set_led_callback", 3);
      Module["_y_engine_set_action_led_callback"] =
        _y_engine_set_action_led_callback = createExportWrapper(
          "y_engine_set_action_led_callback",
          3,
        );
      Module["_malloc"] = _malloc = createExportWrapper("malloc", 1);
      Module["_y_engine_get_amplitude_response_svg"] =
        _y_engine_get_amplitude_response_svg = createExportWrapper(
          "y_engine_get_amplitude_response_svg",
          1,
        );
      Module["_y_engine_get_phase_response_svg"] =
        _y_engine_get_phase_response_svg = createExportWrapper(
          "y_engine_get_phase_response_svg",
          1,
        );
      Module["_y_engine_get_transfer_function_svg"] =
        _y_engine_get_transfer_function_svg = createExportWrapper(
          "y_engine_get_transfer_function_svg",
          1,
        );
      Module["_y_macro_simple_graph"] = _y_macro_simple_graph =
        createExportWrapper("y_macro_simple_graph", 1);
      Module["_free"] = _free = createExportWrapper("free", 1);
      Module["__initialize"] = __initialize = createExportWrapper(
        "_initialize",
        0,
      );
