import { a as MarkerSeverity, c as Range, f as Uri, h as languages, o as MarkerTag, p as editor } from "./fg8HygeD2.js";
import { n as typescriptDefaults } from "./Bz8k6Ebc2.js";
		...
		if (!this._client) this._client = (async () => {
			this._worker = createWebWorker({
				...
				createWorker: () => new Worker(new URL(
					/* @vite-ignore */
					"" + new URL("../workers/ts.worker-VgvC2_zp.js", import.meta.url).href,
					"" + import.meta.url
				), { type: "module" }),
				label: this._modeId,
				keepIdleModels: true,
	...
	async provideDocumentSymbols(model, token) {
		...
		const convert = (item, containerLabel) => {
			...
			return {
				...
				tags: [],
				children: (_item$childItems = item.childItems) === null || _item$childItems === void 0 ? void 0 : _item$childItems.map((child) => convert(child, item.text)),
